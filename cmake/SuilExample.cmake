...
# \group:DEPENDS A list of dependency targets needed by the example target
...
function(SuilExample name)
    ...
    if (SUIL_EXAMPLE_DEPENDS)
        add_dependencies(${name} ${SUIL_EXAMPLE_DEPENDS})
    endif()
    if (SUIL_EXAMPLE_LIBS)
        target_link_libraries(${name} ${SUIL_EXAMPLE_LIBS} ${SUIL_EXAMPLE_DEPENDS})
    endif()
    if (SUIL_EXAMPLE_DEFINES)
        target_compile_definitions(${name} PUBLIC ${SUIL_EXAMPLE_DEFINES})
    endif()
